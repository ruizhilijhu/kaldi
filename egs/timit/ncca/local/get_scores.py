...
'''
Scirpt to give condition(s) WER:
Input:
list of conditions
list of decode dirs
...
# cond_list=["clean", "babble-00","babble-05","babble-10","babble-15","babble-20","benz-00","benz-05","benz-10","benz-15","benz-20","buccaneer1-00","buccaneer1-05","buccaneer1-10","buccaneer1-15","buccaneer1-20","buccaneer2-00","buccaneer2-05","buccaneer2-10","buccaneer2-15","buccaneer2-20","car-00","car-05","car-10","car-15","car-20","destroyerops-00","destroyerops-05","destroyerops-10","destroyerops-15","destroyerops-20","exhall-00","exhall-05","exhall-10","exhall-15","exhall-20","f16-00","f16-05","f16-10","f16-15","f16-20","factory1-00","factory1-05","factory1-10","factory1-15","factory1-20","factory2-00","factory2-05","factory2-10","factory2-15","factory2-20","leopard-00","leopard-05","leopard-10","leopard-15","leopard-20","m109-00","m109-05","m109-10","m109-15","m109-20","restuarant-00","restuarant-05","restuarant-10","restuarant-15","restuarant-20","street-00","street-05","street-10","street-15","street-20","subway-00","subway-05","subway-10","subway-15","subway-20"]

#noise_grp_cond_list=[["clean"], ["babble-00","babble-05","babble-10","babble-15","babble-20"], ["benz-00","benz-05","benz-10","benz-15","benz-20"], ["buccaneer1-00","buccaneer1-05","buccaneer1-10","buccaneer1-15","buccaneer1-20"], ["buccaneer2-00","buccaneer2-05","buccaneer2-10","buccaneer2-15","buccaneer2-20"], ["car-00","car-05","car-10","car-15","car-20"], ["destroyerops-00","destroyerops-05","destroyerops-10","destroyerops-15","destroyerops-20"], ["exhall-00","exhall-05","exhall-10","exhall-15","exhall-20"], ["f16-00","f16-05","f16-10","f16-15","f16-20"], ["factory1-00","factory1-05","factory1-10","factory1-15","factory1-20"], ["factory2-00","factory2-05","factory2-10","factory2-15","factory2-20"], ["leopard-00","leopard-05","leopard-10","leopard-15","leopard-20"], ["m109-00","m109-05","m109-10","m109-15","m109-20"], ["restuarant-00","restuarant-05","restuarant-10","restuarant-15","restuarant-20"], ["street-00","street-05","street-10","street-15","street-20"], ["subway-00","subway-05","subway-10","subway-15","subway-20"]]

noise_grp_cond_list=[["clean"], ["babble-00"], ["babble-05"], ["babble-10"], ["babble-15"],["babble-20"], \
...
fo=open("/export/b04/ruizhili/kaldi/egs/timit/dnnAdaptInit/exp/dnn4_pretrain-dbn_dnn/condition_score.test", "w")
for cond_list in noise_grp_cond_list:
    print "Noise condition: ", cond_list[0]
    print "--  --------------------------------"
    
    
    decode_dirs=['exp/dnn4_pretrain-dbn_dnn']
    wer = get_score(decode_dirs, cond_list, "test")
    
    print wer
    fo.write(cond_list[0]+" [ " + str(wer)+" ]\n")
