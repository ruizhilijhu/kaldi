...
required="$data/feats.scp $mlp $nndir/final.feature_transform"
...
nnet-copy --remove-last-components=$remove_last_components $mlp $nnet 2>$logdir/feature_extractor.log || exit 1
