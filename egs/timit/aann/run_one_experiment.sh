...
outdir_suffix="_lr${lr}${opt}_new"
bash step4_adapt_per_layer.sh --begin yes --first_components $first_components --lr $lr --keep_lr_iters $keep_lr_iters --numLayersFreezeStart $layer_s --numLayersFreeze $layer_e --aannid $aannid --outdir_suffix $outdir_suffix || exit 1
