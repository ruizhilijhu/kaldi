...
#ifndef KALDI_NNET_NNET_LOSS_AANN_H_
#define KALDI_NNET_NNET_LOSS_AANN_H_
...
class Aann : public LossItf_aann {
 public:
  Aann():
    frames_(0.0),
    loss_(0.0),
...
#endif  // KALDI_NNET_NNET_LOSS_AANN_H_
