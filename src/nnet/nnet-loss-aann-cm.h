...
#ifndef KALDI_NNET_NNET_LOSS_AANN_CM_H_
#define KALDI_NNET_NNET_LOSS_AANN_CM_H_
...
class LossItf_aann_cm {
 public:
  LossItf_aann_cm() { }
  virtual ~LossItf_aann_cm() { }
...
class AannCm : public LossItf_aann_cm {
 public:
  AannCm():
    frames_(0.0),
    loss_(0.0),
 ...
 private:
  ...
  CuMatrix<BaseFloat> aann_diff_cm_;
};
 
}  // namespace nnet1
}  // namespace kaldi

#endif  // KALDI_NNET_NNET_LOSS_AANN_CM_H_
